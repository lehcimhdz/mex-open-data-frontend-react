    ...
    <Shell>
      <Suspense fallback={<RouteFallback />}>
        <Routes>
          ...
          <Route
            path="/organizations"
            element={<Navigate to="/organizaciones" replace />}
          />
          ...
          <Route
            path="/datasets/:slug/eda"
            element={<DatasetDetailPage initialTab="eda" />}
          />
          <Route
            path="/datasets/:slug/ml"
            element={<DatasetDetailPage initialTab="ml" />}
          />
